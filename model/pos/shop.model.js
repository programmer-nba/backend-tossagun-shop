...
const ShopSchema = new mongoose.Schema({
    shop_landlord_id: { type: String, required: true },
    shop_investor_id: { type: Array, required: true },
    ...
    shop_type: { type: String, enum: ['One Stop Shop', 'One Stop Service'], required: true },
