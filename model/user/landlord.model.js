...
const LandlordSchema = new mongoose.Schema({
    ...
    landlord_status: { type: Boolean, required: false, default: true }, // สถานะการเปิดให้ใช้งาน
    landlord_promise: {
...
LandlordSchema.method.generateAuthToken = function () {
    const token = jwt.sign(
        { _id: this._id, name: this.landlord_name, phone: this.landlord_phone, row: "landlord" },
...
const validate = (data) => {
    const schema = Joi.object({
        ...
        landlord_status: Joi.boolean().default(true),
